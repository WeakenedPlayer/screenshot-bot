import { TgaConverter, TgaConverterOption, ImageWatcher } from '../src';
...
let option$: Observable<TgaConverterOption> = Observable.of( new TgaConverterOption( 80, tmpDir ) ).shareReplay(1);
let converter$ = new TgaConverter( src.image$, option$ );
